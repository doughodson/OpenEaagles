# OpenEaagles dis library profile
...
# Target names
win32:CONFIG(release, debug|release): TARGET = oeDis
else:win32:CONFIG(debug, debug|release): TARGET = oeDis_d
else:unix:!macx:!symbian: TARGET = oeDis
...
# Header files
HEADERS += \
   $${OE_ROOT}/include/openeaagles/dis/*.h
