...
//----
inline unsigned long Rng::drawInt32()
{ 
...
#else
   unsigned long n1 = u & 0x80000000UL;
   unsigned long n2 = v & 0x7FFFFFFFUL;
   unsigned long n3 = v & 1UL;
   unsigned long n4 = 0x9908B0DFUL;
   
   return ( ((n1 | n2) >> 1) ^ ((n3 ? n4 : 0x0UL)) );
#endif
}
