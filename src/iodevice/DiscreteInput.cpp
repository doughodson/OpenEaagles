...
// process inputs
//------------------------------------------------------------------------------
void DiscreteInput::processInputs(const LCreal dt, const base::IoDevice* const device, base::IoData* const inData)
{
   if (inData != nullptr) {
...
// process outputs
//------------------------------------------------------------------------------
void DiscreteInput::processOutputs(const LCreal, const base::IoData* const, base::IoDevice* const)
{
}
